...
dependency "vpc_logging" {
  config_path = "../vpc-logging"
}
...
inputs = {
  ...
  requestor_vpc_id = dependency.vpc_logging.outputs.vpc_id
  requestor_route_table_id = dependency.vpc_logging.outputs.vpc_main_route_table_id
  requestor_vpc_cidr_block = dependency.vpc_logging.outputs.vpc_cidr_block
}
